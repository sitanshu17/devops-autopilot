...
// SaveTerraformFile saves terraform code to a file
func (s *TerraformService) SaveTerraformFile(code, resource string) (string, error) {
	...
	filePath, err := s.GetNextAvailableFilename(terraformDir, resource, ".tf")
	if err != nil {
...
func (s *TerraformService) GetNextAvailableFilename(dir, resourceText, ext string) (string, error) {
	if dir == "" {
